...
class TestDatasetOneImageRegression(unittest.TestCase):
    ...
    def test_dataset_1_image_1_length_gray(test):
        ...
        dataset = DatasetOneImageRegression(2, "tests/test_data/", 3, 3, torch.float, as_gray=True)
        x = dataset[0]
    ...
    def test_dataset_1_image_1_length_rgb(test):
        ...
        dataset = DatasetOneImageRegression(2, "tests/test_data/", 3, 3, torch.float, as_gray=False)
        x = dataset[0]
    ...
    def test_dataset_1_image_different_lengths_gray(test):
        ...
        dataset = DatasetOneImageRegression(2, "tests/test_data/", 3, 5, torch.float, as_gray=True)
        x = dataset[0]
    ...
    def test_dataset_1_image_different_lengths_rgb(test):
        ...
        dataset = DatasetOneImageRegression(2, "tests/test_data/", 3, 5, torch.float, as_gray=False)
        x = dataset[0]
...
class TestDatasetOneImageClassification(unittest.TestCase):
    ...
    def test_dataset_1_image_1_length_gray(test):
        ...
        dataset = DatasetOneImageClassification(2, "tests/test_data/", 3, 3, 4, torch.float, as_gray=True)
        x = dataset[0]
    ...
    def test_dataset_1_image_1_length_rgb(test):
        ...
        dataset = DatasetOneImageClassification(2, "tests/test_data/", 3, 3, 4, torch.float, as_gray=False)
        x = dataset[0]
    ...
    def test_dataset_1_image_different_lengths_gray(test):
        ...
        dataset = DatasetOneImageClassification(2, "tests/test_data/", 3, 5, 4, torch.float, as_gray=True)
        x = dataset[0]
    ...
    def test_dataset_1_image_different_lengths_rgb(test):
        ...
        dataset = DatasetOneImageClassification(2, "tests/test_data/", 3, 5, 4, torch.float, as_gray=False)
        x = dataset[0]
